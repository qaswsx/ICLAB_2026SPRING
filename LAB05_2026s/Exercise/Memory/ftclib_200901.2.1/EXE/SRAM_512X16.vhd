...
--       Library          : FSA0M_A
--       Memaker          : 200901.2.1
--       Date             : Fri Jun 12 21:41:51 CST 2026
--
-- |-----------------------------------------------------------------------|
...
attribute VITAL_LEVEL0 of SRAM_512X16 : entity is TRUE;
...
architecture behavior of SRAM_512X16 is
...
begin
   ...
   if (TimingChecksOn) then
         VitalSetupHoldCheck (
          ...
          RefTransition           => 'R',
          HeaderMsg               => InstancePath & "/SRAM_512X16",
          Xon                     => Xon,
          MsgOn                   => MsgOn,
          MsgSeverity             => WARNING);
