...
--       Library          : FSA0M_A
--       Memaker          : 200901.2.1
--       Date             : Sun Apr 19 13:57:13 CST 2026
--
-- |-----------------------------------------------------------------------|
...
attribute VITAL_LEVEL0 of SUMA180_128X64X1BM1 : entity is TRUE;
...
architecture behavior of SUMA180_128X64X1BM1 is
...
begin
   ...
   if (TimingChecksOn) then
         VitalSetupHoldCheck (
          ...
          RefTransition           => 'R',
          HeaderMsg               => InstancePath & "/SUMA180_128X64X1BM1",
          Xon                     => Xon,
          MsgOn                   => MsgOn,
          MsgSeverity             => WARNING);
