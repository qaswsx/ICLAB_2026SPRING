...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SRAM_256X128_BC.lib\
    ${::IMEX::libVar}/mmmc/SRAM_512X64_BC.lib\
    ${::IMEX::libVar}/mmmc/SRAM_82X64_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SRAM_256X128_WC.lib\
    ${::IMEX::libVar}/mmmc/SRAM_512X64_WC.lib\
    ${::IMEX::libVar}/mmmc/SRAM_82X64_WC.lib]\
   -si\
