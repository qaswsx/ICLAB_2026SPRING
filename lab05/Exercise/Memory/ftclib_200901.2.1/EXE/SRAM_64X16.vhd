...
--       Library          : FSA0M_A
--       Memaker          : 200901.2.1
--       Date             : Wed Apr 22 21:10:26 CST 2026
--
-- |-----------------------------------------------------------------------|
...
attribute VITAL_LEVEL0 of SRAM_64X16 : entity is TRUE;
...
architecture behavior of SRAM_64X16 is
...
begin
   ...
   if (TimingChecksOn) then
         VitalSetupHoldCheck (
          ...
          RefTransition           => 'R',
          HeaderMsg               => InstancePath & "/SRAM_64X16",
          Xon                     => Xon,
          MsgOn                   => MsgOn,
          MsgSeverity             => WARNING);
